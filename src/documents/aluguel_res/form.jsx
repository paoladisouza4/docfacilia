// ── aluguel_res/form.jsx ───────────────────────────────────────
// Formulário exclusivo: Contrato de Locação Residencial
...
export const fields = {
  ...
  valor: [
    ...
    { id:'val_reajuste', label:'Índice de Reajuste', type:'select', options:['IGPM','IPCA','INPC','Sem reajuste'] },
  ],
  juridico: [
...
export const labels = {
  parteA: 'Locador',
  parteB: 'Locatário',
  step2title: 'Locador  e  Locatário',
}