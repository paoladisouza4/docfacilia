// ── carta_apres/builder.js ───────────────────────────────────────
// Gerador autônomo: Carta de Apresentação Profissional
...
export function build(data) {
  ...
  return `
${cabecalho(num, 'Carta de Apresentação Profissional')}
<div class="doc-subtitle">${dateStr}</div>

<div class="parties-block">
  <div class="parties-title">Partes / Declarante</div>
  <div class="party"><div class="party-role">REMETENTE:</div><p>${partyLine(pa,'REMETENTE')}</p></div>
  ${pb?.nome ? `<div class="party"><div class="party-role">DESTINATÁRIO:</div><p>${partyLine(pb,'DESTINATÁRIO')}</p></div>` : ''}
</div>
