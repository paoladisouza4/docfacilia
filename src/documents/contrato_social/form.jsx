// ── contrato_social/form.jsx ───────────────────────────────────
// Formulário exclusivo: Contrato Social
...
export const fields = {
  ...
  objeto: [
    ...
    { id:'obj_obrig_a', label:"Obrigações do Sócio A",   type:'textarea' },
    { id:'obj_obrig_b', label:"Obrigações do Sócio B",   type:'textarea' },
  ],
  valor: [
    { id:'val_total', label:'Capital Social Total (R$)', type:'money', required:true },
    { id:'val_forma', label:'Forma de Pagamento', type:'select',
      options:['integralização imediata','integralização em prazo acordado'] },
  ...
  juridico: [
    ...
    { id:'jur_extra', label:'Disposições adicionais',  type:'textarea' },
  ],
  testemunhas: [
