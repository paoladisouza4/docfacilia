// ── autonomo/builder.js ──────────────────────────────────────────
// Gerador autônomo: Acordo de Prestação de Serviços Autônomos
...
export function build(data) {
  ...
  return `
${cabecalho(num, 'Acordo de Prestação de Serviços Autônomos')}
...
<div class="parties-block">
  ...
  ${pb?.nome ? `<div class="party"><div class="party-role">PRESTADOR:</div><p>${partyLine(pb,'PRESTADOR')}</p></div>` : ''}
</div>
...
${obj_obrig_a ? `<div class="clausula">
  <div class="clausula-title">Cláusula II — Das Obrigações de Contratante</div>
  <div class="clausula-body">
    <p>2.1. Compete ao CONTRATANTE: ${obj_obrig_a}.</p>
  </div>
</div>` : ''}

${obj_obrig_b && pb?.nome ? `<div class="clausula">
  <div class="clausula-title">Cláusula III — Das Obrigações de Prestador</div>
  <div class="clausula-body">
    <p>3.1. Compete ao PRESTADOR: ${obj_obrig_b}.</p>
  </div>
</div>` : ''}
...
${signaturas({ pa, pb, roleA:'CONTRATANTE', roleB:'PRESTADOR', t1, t2, jur:{local:jur_local}, dateStr })}
${AVISO}`
}
