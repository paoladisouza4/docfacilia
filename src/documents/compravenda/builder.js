// ── compravenda/builder.js ───────────────────────────────────────
// Gerador autônomo: Contrato de Compra e Venda
...
export function build(data) {
  ...
  return `
${cabecalho(num, 'Contrato de Compra e Venda')}
...
<div class="parties-block">
  ...
  ${pb?.nome ? `<div class="party"><div class="party-role">COMPRADOR:</div><p>${partyLine(pb,'COMPRADOR')}</p></div>` : ''}
</div>
...
${obj_obrig_a ? `<div class="clausula">
  <div class="clausula-title">Cláusula II — Das Obrigações de Vendedor</div>
  <div class="clausula-body">
    <p>2.1. Compete ao VENDEDOR: ${obj_obrig_a}.</p>
  </div>
</div>` : ''}

${obj_obrig_b && pb?.nome ? `<div class="clausula">
  <div class="clausula-title">Cláusula III — Das Obrigações de Comprador</div>
  <div class="clausula-body">
    <p>3.1. Compete ao COMPRADOR: ${obj_obrig_b}.</p>
  </div>
</div>` : ''}
...
${signaturas({ pa, pb, roleA:'VENDEDOR', roleB:'COMPRADOR', t1, t2, jur:{local:jur_local}, dateStr })}
${AVISO}`
}
