// ── acordo_inadimpl/builder.js ───────────────────────────────────
// Gerador autônomo: Acordo de Regularização de Inadimplência
...
export function build(data) {
  ...
  return `
${cabecalho(num, 'Acordo de Regularização de Inadimplência')}
<div class="doc-subtitle">${dateStr}</div>

<div class="parties-block">
  <div class="parties-title">Partes</div>
  <div class="party"><div class="party-role">LOCADOR / CREDOR:</div><p>${partyLine(pa,'LOCADOR / CREDOR')}</p></div>
  <div class="party"><div class="party-role">LOCATÁRIO / DEVEDOR:</div><p>${partyLine(pb,'LOCATÁRIO / DEVEDOR')}</p></div>
</div>
...
${signaturas({ pa, pb, roleA:'LOCADOR / CREDOR', roleB:'LOCATÁRIO / DEVEDOR', t1, t2, jur:{local:jur_local}, dateStr })}
${AVISO}`
}
