// ── autonomo/form.jsx ──────────────────────────────────────────
// Formulário exclusivo: Acordo de Prestação de Serviços Autônomos
...
export const fields = {
  ...
  objeto: [
    ...
    { id:'obj_obrig_b', label:"Obrigações do Prestador",   type:'textarea' },
  ],
  valor: [
...
export const labels = {
  parteA: 'Contratante',
  parteB: 'Prestador',
  step2title: 'Contratante  e  Prestador',
}